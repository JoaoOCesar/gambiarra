...
public class PaisController {
    ...
    public void limparListaDePaises() {
        ...
        /*
         * Para exibir a mensagem informando que a camada de dados (listaDePaises)  foi  limpa,  utilizamos  o
         * método limparListaDePaises da camada de visualização (view).
         */
    ...
    public void testaConexao() {
    	if(paisDAO.abreConexao()) {
    		System.out.println("Funcionado");
    		paisDAO.fechaConexao();
    	}else {
    		System.out.println("Conexao fechado");
    	}
    }
}